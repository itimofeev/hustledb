...
func dbMigrations002_forumSql() (*asset, error) {
	...
	info := bindataFileInfo{name: "db/migrations/002_forum.sql", size: 1513, mode: os.FileMode(420), modTime: time.Unix(1478035225, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
...
func dbMigrationsBindataGo() (*asset, error) {
	...
	info := bindataFileInfo{name: "db/migrations/bindata.go", size: 12288, mode: os.FileMode(420), modTime: time.Unix(1478035227, 0)}
	a := &asset{bytes: bytes, info: info}
	return a, nil
}
