...
func InsertData(db *runner.DB, res RawParsingResults) {
...
func insertClub(db *runner.DB, club *RawClub) (*RawClub, error) {
	err := db.
		InsertInto("club").
...
func insertDancerClub(db *runner.DB, dancerClub *RawDancerClub) (*RawDancerClub, error) {
	_, err := db.
...
func insertDancer(db *runner.DB, dancer *RawDancer) (*RawDancer, error) {
	err := db.
		InsertInto("dancer").
...
func insertCompetition(db *runner.DB, competition *RawCompetition) (*RawCompetition, error) {
	err := db.
...
func insertNomination(db *runner.DB, nominations *RawNomination) (*RawNomination, error) {
	err := db.
...
func insertCompResult(db *runner.DB, result *RawCompetitionResult) (*RawCompetitionResult, error) {
	err := db.
		InsertInto("result").
